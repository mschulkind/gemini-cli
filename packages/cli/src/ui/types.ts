...
export type HistoryItemContextStats = HistoryItemBase & {
  type: 'context_stats';
  // Additional fields can be added later as the UI expands what context stats include.
};
